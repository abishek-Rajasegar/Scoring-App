...
<head>
    ...
    <link rel="stylesheet" href="./css/matches.css" type="text/css">
...
<body>
    ...
    <div class="body1">
    	...
    	<%
			...
			String sql1 = "select Team1_name, team2_name, Overs,Venue,Match_date,match_result from matches where Match_date >'2020-08-17';";
        ...
        <div class="box">
            ...
            <div class="content">
                 ...
                 <h5><%=resultSet.getString("Team1_name")%> vs  <%=resultSet.getString("team2_name")%> </h5>

				<h6>Overs : <%=resultSet.getString("Overs")%> </h6>
				<h6> Venue : <%=resultSet.getString("Venue")%></h6>
				<h6> Date & Time : <%=resultSet.getString("Match_date")%> </h6>
                   
                <h5>Won By : <%=resultSet.getString("match_result")%> </h5>
            </div>
        </div>
