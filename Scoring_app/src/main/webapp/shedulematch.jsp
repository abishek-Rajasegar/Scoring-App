...
<body>
	...
	<div class="pos-f-t">
		...
		<nav class="navbar ">
			...
			<a href="#">Schedule Match</a>
		</nav>
	</div>

	<div class="body1">

		<form action="scheduleMatch" method="post">
			<h3>Schedule Match</h3>

			<div class="form-group ">

				<input type="text" name="team1" class="form-control" id="overs"
					placeholder="Team-1 Name" required>
			</div>

			<div class="form-group ">

				<input type="text" name="team2" class="form-control" id="overs"
			...
			<div class="form-group ">
				...
				<input type="datetime-local" name="date"
					class="form-control selection" placeholder="Date Time" required>
			</div>
