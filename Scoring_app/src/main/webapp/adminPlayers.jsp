...
<body>
	...
	<div class="body1">
		<%
			...
			String sql1 = "select player_name, team_name from players p, teams t where p.team_id= t.team_id order by team_name desc;";
		...
		<div class="box">
			...
			<div class="content">
				 <i
					class="fa fa-user-circle fa-5x"></i>
				<h4><%=resultSet.getString("player_name")%></h4>

				<h6><%=resultSet.getString("team_name")%></h6>
