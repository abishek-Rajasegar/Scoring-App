...
<body>
	...
	<%
		Integer total_balls = 0, target = 0, wickets = 0;
	HttpSession sec = request.getSession(false);
	target = (Integer) session.getAttribute("target");
	wickets = (Integer) session.getAttribute("wickets");
	total_balls = (Integer) session.getAttribute("total_balls");
	...
	<div class="body1">
		...
		<div class="box">
			...
			<div class="content">
				...
				<form action="boresult" method="Post">
