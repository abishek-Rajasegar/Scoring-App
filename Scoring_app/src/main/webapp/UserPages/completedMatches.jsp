    ...
    <div class="body1">
        ...
        <div class="box">
            ...
            <div class="content">
                 ...
                 <h4><%=resultSet.getString("Team1_name")%> vs  <%=resultSet.getString("team2_name")%> </h4>

				<h6>Overs : <%=resultSet.getString("Overs")%> | Venue : <%=resultSet.getString("Venue")%>| Date and Time : <%=resultSet.getString("Match_date")%> </h6>
                   
                <h4>Won By : <%=resultSet.getString("match_result")%> </h4>
            </div>
        </div>
