...
<body>
	...
	<div class="body1">
		<form action="newBatsman" method="Post">
			<h2 style="text-align: center;">select Batsman</h2>
			...
			<div class="form-group">
				...
				<select name="newbatsman" class="form-control selection" required>
					<option value="null">Select new batsman</option>
					<%
						while (rs.next()) {
					...
					<%
						if (fname.equals(striker) || fname.equals(nonStriker)) {
						continue;
					}
					%>
