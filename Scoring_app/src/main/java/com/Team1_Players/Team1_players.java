...
public class Team1_players extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		session1.setAttribute("captain_1",player1 );
		session1.setAttribute("team_name_1",team_name);	
		response.sendRedirect("TeamB.jsp");
	}
